"""CAP Sleep Database (capslpdb/1.0.0) EEG/EMG/respiration preprocessing.
Per-modality band-pass (EEG 0.5-40, EMG 10-45, RESP 0.01-1 Hz), 50 Hz notch, sleep-stage masking.

Provenance: extracted verbatim from the notebook ``sleep-data-CAPS.ipynb``.
