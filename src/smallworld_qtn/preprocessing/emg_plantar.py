"""PhysioNet 'plantar/1.0.0' surface-EMG preprocessing + QTN/GAF/MTF small-world pipeline.
EMG band-pass 20-450 Hz, 50 Hz notch, epoch peak-to-peak QC.

Provenance: extracted verbatim from the notebook ``EMG.ipynb``.
