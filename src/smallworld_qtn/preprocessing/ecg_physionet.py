"""PhysioNet ECG preprocessing for Fantasia (fantasia/1.0.0) and NSRDB (nsrdb/1.0.0).
ECG band-pass 0.5-40 Hz, 50 Hz notch, resampling, epoch QC, then QTN/GAF/MTF metrics.

Provenance: extracted verbatim from the notebook ``ecg-2-data-FINAL.ipynb``.
