"""COBRE + ADHD-Bureau fMRI download and BASC-122 time-series export.

Provenance: extracted verbatim from ``Preprocessing-ABIDE-final.ipynb``.
Downloads the resting-state fMRI cohorts from S3 and exports per-subject
BASC-122 regional BOLD time-series CSVs (T x 122) consumed by
analysis/fmri_basc122_pipeline.py. Requires AWS credentials / boto3 and the
environment variables set in the first cell.
"""
