"""Surrogate-based validation on the ABIDE dataset (Fig. 8): real-minus-surrogate
differences per metric and representation, one-sided Wilcoxon + FDR.

Provenance: extracted verbatim from the notebook ``heatmap-surrogate analysis.ipynb``.
