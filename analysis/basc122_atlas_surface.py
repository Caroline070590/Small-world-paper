"""Fetches the BASC-122 atlas (nilearn) and renders the cortical surface
projection used in Supplementary Fig. S3, plus parcel-label tables.

Provenance: extracted verbatim from the notebook ``map.ipynb``.
"""
