#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Auto-converted from the Jupyter notebook ``boxplot-sleep.ipynb``.
...
# ---------- input files ----------
FILES = {
   # "QTN": "sleep_outputs/cap_sleep_controls/ALL_SLEEP/metrics_GAF_cap_sleep_controls_ALL_SLEEP_NREM.csv",
    #"GAF": "sleep_outputs/cap_sleep_controls/ALL_SLEEP/metrics_GAF_cap_sleep_controls_ALL_SLEEP_NREM.csv",
    #"MTF": "sleep_outputs/cap_sleep_controls/ALL_SLEEP/metrics_MTF_cap_sleep_controls_ALL_SLEEP_NREM.csv",
  #  "QTN": "sleep_outputs/cap_sleep_controls/EEG/metrics_QTN_cap_sleep_controls_EEG_NREM.csv",
   # "GAF": "sleep_outputs/cap_sleep_controls/EEG/metrics_GAF_cap_sleep_controls_EEG_NREM.csv",
   # "MTF": "sleep_outputs/cap_sleep_controls/EEG/metrics_MTF_cap_sleep_controls_EEG_NREM.csv",
    #"QTN": "sleep_outputs/cap_sleep_controls/EMG/metrics_QTN_cap_sleep_controls_EMG_NREM.csv",
    #"GAF": "sleep_outputs/cap_sleep_controls/EMG/metrics_GAF_cap_sleep_controls_EMG_NREM.csv",
    #"MTF": "sleep_outputs/cap_sleep_controls/EMG/metrics_MTF_cap_sleep_controls_EMG_NREM.csv",
    "QTN": "sleep_outputs/cap_sleep_controls/RESP/metrics_QTN_cap_sleep_controls_RESP_NREM.csv",
    "GAF": "sleep_outputs/cap_sleep_controls/RESP/metrics_GAF_cap_sleep_controls_RESP_NREM.csv",
    "MTF": "sleep_outputs/cap_sleep_controls/RESP/metrics_MTF_cap_sleep_controls_RESP_NREM.csv",
...
OUT_DIR         = "Boxplot-ALL_SLEEP"
#OUT_PLOT_PNG    = "sigma_violin_box_points_lines-ALL_SLEEP.png"
#OUT_PLOT_PDF    = "sigma_violin_box_points_lines-ALL_SLEEP.pdf"
#OUT_WIDE_CSV    = "sigma_wide_matched-ALL_SLEEP.csv"
#OUT_LONG_CSV    = "sigma_long_matched-ALL_SLEEP.csv"
#OUT_PLOT_PNG    = "sigma_violin_box_points_lines-EEG.png"
#OUT_PLOT_PDF    = "sigma_violin_box_points_lines-EEG.pdf"
#OUT_WIDE_CSV    = "sigma_wide_matched-EEG.csv"
#OUT_LONG_CSV    = "sigma_long_matched-EEG.csv"
OUT_PLOT_PNG    = "sigma_violin_box_points_lines-RESP.png"
OUT_PLOT_PDF    = "sigma_violin_box_points_lines-RESP.pdf"
OUT_WIDE_CSV    = "sigma_wide_matched-RESP.csv"
OUT_LONG_CSV    = "sigma_long_matched-RESP.csv"
