#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Auto-converted from the Jupyter notebook ``boxplot-aeration.ipynb``.
...
# ---------- input files ----------
FILES = {
    "QTN": "resp_outputs/out_resp_aeration_stream/metrics_QTN_resp_aeration_stream_per_file.csv",
    "GAF": "resp_outputs/out_resp_aeration_stream/metrics_GAF_resp_aeration_stream_per_subject.csv",
    "MTF": "resp_outputs/out_resp_aeration_stream/metrics_MTF_resp_aeration_stream_per_subject.csv",
...
OUT_DIR         = "Boxplot-aeration"
OUT_PLOT_PNG    = "sigma_violin_box_points_lines-aeration.png"
OUT_PLOT_PDF    = "sigma_violin_box_points_lines-aeration.pdf"
OUT_WIDE_CSV    = "sigma_wide_matched-aeration.csv"
OUT_LONG_CSV    = "sigma_long_matched-aeration.csv"
